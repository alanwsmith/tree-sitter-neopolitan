...
enum ts_symbol_identifiers {
  ...
  sym_section_dashes = 14,
  sym_section_start_end_token = 15,
  sym_todo_left_bracket = 16,
  sym_todo_right_bracket = 17,
  sym_todo_checkmark = 18,
  sym_not_a_checkmark = 19,
  sym_code_body = 20,
  sym_html_body = 21,
  sym_list_token = 22,
  sym_single_space = 23,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [17] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(99),
  ...
  [90] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_code_end_section, 7),
  [92] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_p_section, 7, .production_id = 5),
  [94] = {.entry = {.count = 1, .reusable = true}}, SHIFT(45),
  [96] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_title_section, 6),
  [98] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_title_section, 7, .production_id = 5),
  ...
  [114] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_code_start_section_repeat1, 2, .production_id = 3), SHIFT_REPEAT(70),
  ...
  [123] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_html_end_section, 7),
  ...
  [144] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_paragraph, 3),
  [146] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_paragraph, 3),
  ...
  [164] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_headline, 1, .production_id = 4),
  ...
  [184] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_attr_bool, 4, .production_id = 7),
  ...
  [190] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_attr_kv_pair, 7),
...
enum ts_external_scanner_symbol_identifiers {
  ...
  ts_external_token_section_dashes = 3,
  ts_external_token_single_space = 4,
  ts_external_token_title_token = 5,
  ts_external_token_todo_token = 6,
