...
enum ts_symbol_identifiers {
  ...
  sym_attr_kv_pair = 27,
  sym_attr_bool = 28,
  sym_attr_bool_value = 29,
  sym_attr_key = 30,
  sym_code_end_section = 31,
  sym_code_start_section = 32,
  sym_headline = 33,
  sym_html_end_section = 34,
  sym_html_start_section = 35,
  sym_initial_word_chars = 36,
  sym_list_item = 37,
  sym_list_section = 38,
  sym_lt_with_non_lt_char = 39,
  sym_p_section = 40,
  sym_paragraph = 41,
  sym_paragraph_body = 42,
  sym_paragraph_first_word = 43,
  sym_title_section = 44,
  sym_empty_todo_bracket = 45,
  sym_completed_todo_bracket = 46,
  sym_in_progress_todo_bracket = 47,
  sym_todo_item = 48,
  sym_todo_section = 49,
  sym_word = 50,
  sym__wordbreak = 51,
  aux_sym_source_file_repeat1 = 52,
  aux_sym_code_end_section_repeat1 = 53,
  aux_sym_code_start_section_repeat1 = 54,
  aux_sym_list_section_repeat1 = 55,
  aux_sym_paragraph_repeat1 = 56,
  aux_sym_todo_item_repeat1 = 57,
  aux_sym_todo_section_repeat1 = 58,
  anon_alias_sym_headline = 59,
};
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [28] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_todo_section_repeat1, 2), SHIFT_REPEAT(53),
  ...
  [37] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_todo_section, 6, .production_id = 6),
  ...
  [53] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_paragraph_repeat1, 2), SHIFT_REPEAT(84),
  [56] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_paragraph_repeat1, 2),
  [58] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_paragraph_repeat1, 2), SHIFT_REPEAT(86),
  ...
  [73] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_code_end_section_repeat1, 2),
  [75] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_code_end_section_repeat1, 2),
  [77] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_code_end_section_repeat1, 2), SHIFT_REPEAT(99),
  [80] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_list_item, 3),
  [82] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_list_item, 3),
  [84] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_title_section, 6),
  ...
  [98] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_title_section, 6, .production_id = 6),
  [100] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_html_end_section, 6),
  [102] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_code_end_section, 6),
  [104] = {.entry = {.count = 1, .reusable = true}}, SHIFT(56),
  [106] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_title_section, 5),
  [108] = {.entry = {.count = 1, .reusable = true}}, SHIFT(47),
  [110] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_p_section, 6, .production_id = 6),
  [112] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_p_section, 5),
  [114] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_code_start_section_repeat1, 2, .production_id = 3), SHIFT_REPEAT(78),
  [117] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_code_start_section_repeat1, 2, .production_id = 3),
  [119] = {.entry = {.count = 1, .reusable = true}}, SHIFT(46),
  [121] = {.entry = {.count = 1, .reusable = true}}, SHIFT(58),
  [123] = {.entry = {.count = 1, .reusable = true}}, SHIFT(98),
  [125] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_title_section, 7, .production_id = 6),
  [127] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_list_section_repeat1, 2),
  [129] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_list_section_repeat1, 2), SHIFT_REPEAT(81),
  [132] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_list_section, 6, .production_id = 6),
  [134] = {.entry = {.count = 1, .reusable = false}}, SHIFT(81),
  [136] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_list_section, 5),
  ...
  [148] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_headline, 1, .production_id = 4),
  ...
  [168] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_attr_kv_pair, 7),
  [170] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_word, 2),
  [172] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_word, 2),
  [174] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_code_start_section, 6, .production_id = 5),
  [176] = {.entry = {.count = 1, .reusable = true}}, SHIFT(83),
  [178] = {.entry = {.count = 1, .reusable = true}}, SHIFT(79),
  [180] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_html_start_section, 6),
  [182] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_attr_key, 1),
  [184] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_attr_bool_value, 1),
  [186] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_attr_bool, 4, .production_id = 8),
  [188] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_code_start_section, 7, .production_id = 7),
  [190] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_paragraph_first_word, 2),
  [192] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_paragraph_first_word, 2),
  ...
  [252] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_lt_with_non_lt_char, 2),
