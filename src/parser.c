...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [16] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_todo_item_repeat1, 2), SHIFT_REPEAT(66),
  ...
  [27] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_todo_section_repeat1, 2), SHIFT_REPEAT(54),
  ...
  [37] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_paragraph_repeat1, 2), SHIFT_REPEAT(66),
  ...
  [65] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_list_item_repeat1, 2), SHIFT_REPEAT(71),
  ...
  [109] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_list_section_repeat1, 2), SHIFT_REPEAT(84),
  [112] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_list_section_repeat1, 2),
  ...
  [140] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_wordbreak, 1),
  ...
  [158] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_paragraph_first_word, 2),
  [160] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_paragraph_first_word, 2),
  [162] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_word, 2),
  [164] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_word, 2),
  ...
  [176] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_initial_word_chars, 1),
