...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [32] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_todo_section_repeat1, 2), SHIFT_REPEAT(54),
  ...
  [63] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_list_item, 3),
  [65] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_list_item, 3),
  ...
  [75] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_code_end_section_repeat1, 2), SHIFT_REPEAT(89),
  ...
  [88] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_p_section, 6),
  [90] = {.entry = {.count = 1, .reusable = true}}, SHIFT(19),
  [92] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_title_section, 8, .production_id = 5),
  [94] = {.entry = {.count = 1, .reusable = true}}, SHIFT(84),
  [96] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_title_section, 7),
  [98] = {.entry = {.count = 1, .reusable = true}}, SHIFT(47),
  [100] = {.entry = {.count = 1, .reusable = true}}, SHIFT(44),
  [102] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_html_end_section, 7),
  [104] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_code_end_section, 7),
  [106] = {.entry = {.count = 1, .reusable = true}}, SHIFT(53),
  [108] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_code_start_section_repeat1, 2, .production_id = 4), SHIFT_REPEAT(101),
  [111] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_code_start_section_repeat1, 2, .production_id = 4),
  [113] = {.entry = {.count = 1, .reusable = true}}, SHIFT(43),
  [115] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_p_section, 7, .production_id = 5),
  [117] = {.entry = {.count = 1, .reusable = true}}, SHIFT(58),
  [119] = {.entry = {.count = 1, .reusable = true}}, SHIFT(45),
  [121] = {.entry = {.count = 1, .reusable = true}}, SHIFT(21),
  [123] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_title_section, 6),
  [125] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_title_section, 7, .production_id = 5),
  [127] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_list_section_repeat1, 2),
  [129] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_list_section_repeat1, 2), SHIFT_REPEAT(80),
  ...
  [174] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_attr_key, 1),
  [176] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_attr_bool_value, 1),
  ...
  [186] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__attr, 1, .production_id = 2),
  [188] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_code_start_section, 7, .production_id = 6),
  [190] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_attr_bool, 4, .production_id = 7),
  ...
  [242] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_completed_todo_bracket, 3),
  [244] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_in_progress_todo_bracket, 3),
